...
export function IconWand({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconSequencer({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <rect x="2"  y="4"  width="5" height="4" rx="1" />
      <rect x="10" y="4"  width="5" height="4" rx="1" />
      <rect x="2"  y="11" width="8" height="4" rx="1" />
      <rect x="14" y="11" width="8" height="4" rx="1" />
      <rect x="6"  y="18" width="5" height="4" rx="1" />
      <rect x="14" y="18" width="5" height="4" rx="1" />
    </svg>
  )
}

export function IconGuitar({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      {/* Guitar pick shape */}
      <path d="M12 2C8.7 2 6 4.7 6 8c0 2.8 1.7 5.2 4.2 7.2L12 22l1.8-6.8C16.3 13.2 18 10.8 18 8c0-3.3-2.7-6-6-6Z" />
    </svg>
  )
}
...
export function IconMetronome({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <polygon points="12 2 4 20 20 20" />
...
export function IconMidi({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
